        ...
        <div style={{ margin: '0 auto', maxWidth: '850px', width: '100%', padding: '4rem 2rem', boxSizing: 'border-box' }}>
          ...
          <section className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 mb-10">
            ...
            <ul className="list-disc pl-8 space-y-2 text-lg text-gray-800 mb-6">
              ...
              <li><strong>Scenario B (ΛCDM Pipeline):</strong> What biased standard pipelines will artificially claim</li>
            </ul>
          ...
          <section className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 mb-10">
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.95rem' }}>
                ...
                <tbody>
                  <tr style={{ borderBottom: '1px solid rgba(255, 255, 255, 0.05)' }}>
                    ...
                    <td style={{ padding: '0.75rem', color: '#10b981' }}>Gaps = deterministic result of Viscous Shear from T_μν hydrodynamic friction</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <ol className="list-decimal pl-8 space-y-2 text-lg text-gray-800 mb-6">
              <li>Local gravitational acceleration drops below the Cortez Limit: <span style={{ fontStyle: 'italic' }}>a₀ = 1.2001 × 10⁻¹⁰ m/s²</span></li>
              <li>The system undergoes Viscous Shear caused by baryonic system coupling to the temporal tensor field (T_μν)</li>
            ...
            <p className="text-justify leading-relaxed text-lg mb-6">
              Toggle between RRT (laminar, deterministic) and ΛCDM (stochastic, chaotic) stellar stream morphologies:
            </p>
            ...
            <div style={{ marginBottom: '2rem', textAlign: 'center' }}>
              ...
              >
                {isRRT ? '🟦 RRT: Laminar Flow' : '🟥 ΛCDM: Stochastic Spray'}
              </button>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '2rem' }}>
              {[
                ...
                { name: 'Fjörm', range: '10.0–14.3 kpc' },
            ...
            <div style={{ backgroundColor: 'rgba(239, 68, 68, 0.1)', border: '2px solid rgba(239, 68, 68, 0.3)', borderRadius: '8px', padding: '1.5rem' }}>
              <h4 style={{ margin: '0 0 1rem 0', color: '#ef4444', fontWeight: 'bold' }}>Scenario B: N-Body Forcing (ΛCDM Failure)</h4>
              <ul className="list-disc pl-6 space-y-2 text-gray-300 mb-0">
                <li>Researchers artificially insert 10⁵M☉ dark matter halos into simulations</li>
          ...
          <section className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 mb-10">
            ...
            <p className="text-justify leading-relaxed text-lg mb-4">
              The Euclid satellite will map weak gravitational lensing in unprecedented detail. RRT predicts a unique <strong>rotational (B-mode) signature</strong> in shear maps—the imprint of the anisotropic temporal tensor field on light propagation.
            </p>
            ...
            <div style={{ backgroundColor: 'rgba(255, 255, 255, 0.02)', border: '1px solid rgba(255, 255, 255, 0.05)', borderRadius: '8px', padding: '1.5rem', marginBottom: '2rem', fontFamily: 'monospace' }}>
              <p style={{ margin: 0, color: '#a855f7', marginBottom: '0.5rem' }}>γ(θ,z) = γ_ISO(θ) [1 + A_T(z) cos(2(ϕ − ϕ_T(z)))]</p>
            ...
            <div style={{ backgroundColor: 'rgba(255, 255, 255, 0.02)', border: '1px solid rgba(255, 255, 255, 0.05)', borderRadius: '8px', padding: '1.5rem', marginBottom: '2rem', fontFamily: 'monospace' }}>
              ...
              <p style={{ margin: '0.5rem 0 0 0', color: '#a1a1aa', fontSize: '0.9rem' }}>Angular gradient in low multipoles (ℓ &lt; 20)</p>
            </div>
            ...
            <div style={{ backgroundColor: 'rgba(255, 255, 255, 0.02)', border: '1px solid rgba(255, 255, 255, 0.05)', borderRadius: '8px', padding: '1.5rem', fontFamily: 'monospace' }}>
              <p style={{ margin: 0, color: '#10b981' }}>dϕ_T/dt = (0.12 ± 0.03) degrees per century</p>
          ...
          <section className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 mb-10">
            ...
            <p className="text-justify leading-relaxed text-lg mb-4">
              Measurements of H₀ restricted exclusively to the interior of large cosmic voids should yield <strong>systematically higher values</strong> than measurements within dense superclusters:
            </p>

            <div style={{ backgroundColor: 'rgba(255, 255, 255, 0.02)', border: '1px solid rgba(255, 255, 255, 0.05)', borderRadius: '8px', padding: '1.5rem', marginBottom: '2rem', fontFamily: 'monospace' }}>
              <p style={{ margin: 0, color: '#fbbf24' }}>H₀,void &gt; H₀,supercluster</p>
              <p style={{ margin: '0.5rem 0 0 0', color: '#a1a1aa', fontSize: '0.9rem' }}>K_eff → 1 (perfect RRT agreement)</p>
            </div>
