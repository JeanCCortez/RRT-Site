        ...
        <div style={{ margin: '0 auto', maxWidth: '850px', width: '100%', padding: '4rem 2rem', boxSizing: 'border-box' }}>
          ...
          <section className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 mb-10">
            ...
            <p className="text-justify leading-relaxed text-lg mb-4">
              The power of a scientific theory lies not in its ability to explain past observations, but in its capacity to make <strong>testable, falsifiable predictions about future observations</strong>. RRT presents a deterministic agendaÔÇöthe Falsification ProtocolÔÇöfor how observable data from next-generation astronomical surveys will distinguish between RRT and the standard ╬øCDM model.
            </p>
            <p className="text-justify leading-relaxed text-lg">
              This page outlines specific, quantitative predictions for major observatories arriving over the next 3ÔÇô5 years. Each prediction employs a "Dual Scenario" framework: Scenario A represents what RRT predicts will appear in <em>raw, unmanipulated data</em>, while Scenario B shows what standard pipelines will claim by artificially forcing the data into an isotropic mold.
            </p>
          </section>
          ...
          <section className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 mb-10">
            ...
            <ul className="list-disc pl-8 space-y-2 text-lg text-gray-800 mb-6">
              ...
              <li><strong>Scenario B (╬øCDM Pipeline):</strong> What biased standard pipelines will artificially claim</li>
            </ul>
          ...
          <section className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 mb-10">
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.95rem' }}>
                ...
                <tbody>
                  <tr style={{ borderBottom: '1px solid rgba(255, 255, 255, 0.05)' }}>
                    ...
                    <td style={{ padding: '0.75rem', color: '#10b981' }}>Gaps = deterministic result of Viscous Shear from T_╬╝╬¢ hydrodynamic friction</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <ol className="list-decimal pl-8 space-y-2 text-lg text-gray-800 mb-6">
              <li>Local gravitational acceleration drops below the Cortez Limit: <span style={{ fontStyle: 'italic' }}>aÔéÇ = 1.2001 ├ù 10Ôü╗┬╣Ôü░ m/s┬▓</span></li>
              <li>The system undergoes Viscous Shear caused by baryonic system coupling to the temporal tensor field (T_╬╝╬¢)</li>
            ...
            <p className="text-justify leading-relaxed text-lg mb-6">
              Toggle between RRT (laminar, deterministic) and ╬øCDM (stochastic, chaotic) stellar stream morphologies:
            </p>
            ...
            <div style={{ marginBottom: '2rem', textAlign: 'center' }}>
              ...
              >
                {isRRT ? '­ƒƒª RRT: Laminar Flow' : '­ƒƒÑ ╬øCDM: Stochastic Spray'}
              </button>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '2rem' }}>
              {[
                { name: 'Phlegethon', range: '12.5ÔÇô16.2 kpc' },
                { name: 'Fj├Ârm', range: '10.0ÔÇô14.3 kpc' },
                { name: 'Slidr', range: '16.0ÔÇô19.8 kpc' },
                { name: 'Sylgr', range: '13.0ÔÇô16.7 kpc' },
                { name: 'Ylgr', range: '11.0ÔÇô14.9 kpc' }
              ].map((stream, idx) => (
            ...
            <div style={{ backgroundColor: 'rgba(239, 68, 68, 0.1)', border: '2px solid rgba(239, 68, 68, 0.3)', borderRadius: '8px', padding: '1.5rem' }}>
              <h4 style={{ margin: '0 0 1rem 0', color: '#ef4444', fontWeight: 'bold' }}>Scenario B: N-Body Forcing (╬øCDM Failure)</h4>
              <ul className="list-disc pl-6 space-y-2 text-gray-300 mb-0">
                <li>Researchers artificially insert 10ÔüÁMÔÿë dark matter halos into simulations</li>
          ...
          <section className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 mb-10">
            ...
            <p className="text-justify leading-relaxed text-lg mb-4">
              The Euclid satellite will map weak gravitational lensing in unprecedented detail. RRT predicts a unique <strong>rotational (B-mode) signature</strong> in shear mapsÔÇöthe imprint of the anisotropic temporal tensor field on light propagation.
            </p>
            ...
            <div style={{ backgroundColor: 'rgba(255, 255, 255, 0.02)', border: '1px solid rgba(255, 255, 255, 0.05)', borderRadius: '8px', padding: '1.5rem', marginBottom: '2rem', fontFamily: 'monospace' }}>
              <p style={{ margin: 0, color: '#a855f7', marginBottom: '0.5rem' }}>╬│(╬©,z) = ╬│_ISO(╬©) [1 + A_T(z) cos(2(¤ò ÔêÆ ¤ò_T(z)))]</p>
            ...
            <div style={{ backgroundColor: 'rgba(255, 255, 255, 0.02)', border: '1px solid rgba(255, 255, 255, 0.05)', borderRadius: '8px', padding: '1.5rem', marginBottom: '2rem', fontFamily: 'monospace' }}>
              ...
              <p style={{ margin: '0.5rem 0 0 0', color: '#a1a1aa', fontSize: '0.9rem' }}>Angular gradient in low multipoles (Ôäô &lt; 20)</p>
            </div>
            ...
            <div style={{ backgroundColor: 'rgba(255, 255, 255, 0.02)', border: '1px solid rgba(255, 255, 255, 0.05)', borderRadius: '8px', padding: '1.5rem', fontFamily: 'monospace' }}>
              <p style={{ margin: 0, color: '#10b981' }}>d¤ò_T/dt = (0.12 ┬▒ 0.03) degrees per century</p>
          ...
          <section className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 mb-10">
            ...
            <p className="text-justify leading-relaxed text-lg mb-4">
              Measurements of HÔéÇ restricted exclusively to the interior of large cosmic voids should yield <strong>systematically higher values</strong> than measurements within dense superclusters:
            </p>

            <div style={{ backgroundColor: 'rgba(255, 255, 255, 0.02)', border: '1px solid rgba(255, 255, 255, 0.05)', borderRadius: '8px', padding: '1.5rem', marginBottom: '2rem', fontFamily: 'monospace' }}>
              <p style={{ margin: 0, color: '#fbbf24' }}>HÔéÇ,void &gt; HÔéÇ,supercluster</p>
              <p style={{ margin: '0.5rem 0 0 0', color: '#a1a1aa', fontSize: '0.9rem' }}>K_eff ÔåÆ 1 (perfect RRT agreement)</p>
            </div>
